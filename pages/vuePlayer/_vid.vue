          ...
          <div class="mt20 c-infor-box">
                    ...
                    <div>
                      <div v-clickoutside="hideReplyBtn" @click="inputFocus" class="my-reply">
                        ...
                        <div class="reply-btn-box" v-show="btnShow">
                          <el-button class="reply-btn" size="medium" @click="sendComment" type="primary">发表评论
                          </el-button>
                        </div>
                      </div>
                      <!-- /无数据提示 开始-->
                      ...
                      <div v-for="(item,i) in comments" :key="i" class="author-title reply-father">
                        ...
                        <div class="icon-btn">
                          <span @click="showReplyInput(i,item.nickname,item.id)"><i
                        ...
                        <div class="reply-box">
                          <div :v-if="item.children&&item.children.length>0" v-for="(reply,j) in item.children" :key="j"
                               class="author-title">
                            ...
                            <div class="icon-btn">
                              <span @click="showReplyInput(i,reply.nickname,reply.id)"><i
                            ...
                            <div class="reply-box">
                              <div :v-if="reply.children&&reply.children.length>0" v-for="(reply,k) in reply.children"
                                   :key="k" class="author-title">
                                <el-avatar class="header-img" :size="40" :src="reply.avatar"></el-avatar>
                                <div class="author-info">
                                  <span class="author-name">{{ reply.nickname }}</span>
                                  <span class="author-time">{{ reply.gmtCreate }}</span>
            ...
            <aside class="fl col-3">
                    ...
                    <ul style="height: auto;">
                      <li>
                        ...
                        <section class="hLh30 txtOf">
                          <a :href="'../teacher/'+courseWebVo.teacherId" target="_blank"
                             class="c-333 fsize16 fl">{{ courseWebVo.teacherName }}</a>
              ...
              <div v-show="privateMess_inputShow" class="my-reply">
                ...
                <div>
                  <el-input v-model="privateMess" rows="5" type="textarea" maxlength="500"
                            placeholder="输入想对老师说的话(在500字以内)..."></el-input>
                </div>
                <div class=" reply-btn-box">
                  <el-button class="reply-btn" size="medium" @click="sendCommentPrivateMess()" type="primary">发送
                  </el-button>
                </div>
              </div>
              ...
              <div>
                            ...
                            <ol class="lh-menu-ol" style="display: block;">
                              <li class="lh-menu-second ml30" v-for="video in chapter.children" :key="video.id">
                                ...
                                <el-row type="flex" justify="space-between">
                                  ...
                                  <span>
                                      <el-button size="min" v-if="isNotNull(video.videoSourceUrl)" type="primary"
                                                 @click="onPlayer(video.videoSourceId,video.videoSourceUrl)"><i
                                        class="el-icon-video-play"></i>播放</el-button>
                                      <el-button size="min" v-if="!isNotNull(video.videoSourceUrl)" type="warning"><i
                                        class="el-icon-info"></i>未上传视频</el-button>
                                    </span>
                                </el-row>
                              </li>
                            </ol>
                ...
                <div class="mt50">
                  ...
                  <div class="course-txt-body-wrap">
                    <br/>
                    <br/>
                    <el-button v-if="isNotNull(courseWebVo.zipData)" type="primary"
                               @click="downloadFile(courseWebVo.zipData)"><i class="el-icon-download"></i>下载课程资料
                    </el-button>
                    <el-button v-if="!isNotNull(courseWebVo.zipData)" type="warning"><i class="el-icon-info"></i>未上传资料
                    </el-button>
                  </div>
                </div>
                <!-- /资料下载 -->
