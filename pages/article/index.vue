                  ...
                  <section class="mt10 hLh20 of">
                    <span v-if="isNotNull(item.zipData)" class="fr jgTag bg-green">
                        <a :href="item.zipData" target="_blank">
                            <i class="c-fff fsize12 f-fA">下载资料</i>
                        </a>
                    </span>
                    <span v-if="!isNotNull(item.zipData)" class="fr jgTag bg-green">
                      <i class="c-fff fsize12 f-fA">未上传资料</i>
                    </span>
...
export default {
  ...
  methods: {
    ...
    //查询第一页数据
    initCourseFirst() {
      courseApi.getFrontCourseArticleList(1,8,this.searchObj)
               .then(response => {
    ...
    //分页切换的方法
    gotoPage(page) {
        courseApi.getFrontCourseArticleList(page,8,this.searchObj)
                .then(response => {
                   this.data = response.data.data
                })
    },
