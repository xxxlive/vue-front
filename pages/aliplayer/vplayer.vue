...
export default {
    ...
    // 在vue中怎么使用Aliplayer
        ...
        props: {
            ...
            source: {
                type: String,
                default: "http://player.pier39.cn/video/yunxi.mp4"
            ...
            components:[]   //播放器组件，实现基础功能之外的高级功能
        },
        data() {
            return {
        ...
        //用户自定义绑定数据方法
            ...
            init(){
                this.$props.source=this.vUrl;
                const vListComponent={
                name : 'PlaylistComponent',
                type: AliPlayerComponent.PlaylistComponent,
                args:this.videoListArgs
                };
                //this.$props.components.push(vListComponent);//加载组件
                skinLayout:[
